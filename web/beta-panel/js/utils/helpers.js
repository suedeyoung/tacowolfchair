$(function() {
    ...
    // Panel version.
    helpers.PANEL_VERSION = '1.1 (BETA)';
    ...
    helpers.handleInputDate = function(obj) {
        ...
        // Make sure the input has a value in it.
        if (obj.val().match(/^((\d{2})(\\|\/|\.|-)(\d{2})(\\|\/|\.|-)(\d{4}))$/) === null) {
            if (!obj.parent().hasClass('has-error')) {
                // Add the error class to the parent.
                obj.parent().addClass('has-error');
                // Append text saying the form cannot be empty.
	 ...
	 * @param {String} id
	 */
	helpers.handlePanelSetInfo = function(obj, id) {
    ...
    helpers.handleDarkMode = function(isDark, isAtLoadUp) {
        ...
        if (isDark) {
            ...
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/vendors/select2/select2.dark.min.css'
            }));

            // AdminLTE.
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/css/adminlte/AdminLTE.dark.min.css'
            }));

            // skins.
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/css/adminlte/skins/skin-purple.dark.min.css'
            }));

            // AdminLTE.
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/css/style.dark.min.css'
            }));
        } else {
            // select2.
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/vendors/select2/select2.min.css'
            }));

            // AdminLTE.
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/css/adminlte/AdminLTE.min.css'
            }));

            // skins.
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/css/adminlte/skins/skin-purple.min.css'
            }));

            // AdminLTE.
            head.append($('<link/>', {
                'rel': 'stylesheet',
                'href': 'beta-panel/css/style.min.css'
            }));
        }
    };
